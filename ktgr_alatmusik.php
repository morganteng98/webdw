...
<div class="row" style="padding: 100px;">
	...
	<?php $ambil = $koneksi ->query("SELECT * FROM produk where jenis_produk='alat_musik'"); ?><!-- dari database belajar -->
	<?php while($perproduk = $ambil->fetch_assoc()){  ?>
			
	<div class="col-md-3" style="margin-bottom: 50px;text-align: center;">
		<div class="thumnail" style="background-color: #eaeaea; border: solid #eaeaea;border-radius: 10px;height: 100%">
			<img src="foto/<?php echo $perproduk['foto_produk'];?>" style="height: 150px;width: 200px">
