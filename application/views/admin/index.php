        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="assets/assets/dist/img/user4-128x128.jpg" alt="user image" class="online">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="assets/assets/dist/img/user2-160x160.jpg" alt="user image" class="offline">
          ...
          <?php $this->load->view("admin/_parsial/todowidget.php") ?>
<!-- tempat todo widget -->
          ...
          <!-- quick email widget -->
          <?php $this->load->view("admin/_parsial/emailwidget.php") ?>
