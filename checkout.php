				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="form-group">
							<input type="text" readonly value="<?php echo $_SESSION["user"]["nama_pelanggan"]?>" class="form-control" style="background-color: blue;color:white"> 
						</div>
					</div>

					<div class="col-md-4">
						<div class="form-group">
							<input type="text" readonly value="<?php echo $_SESSION["user"]["nomer_telepon"]?>" class="form-control" style="background-color: #007bff;color:white">
						</div>
					</div>

					<div class="col-md-4">
							<select class="form-control" name="id_ongkir" style="height: 34px;background-color: blue;color:white" required="Harus">
					...
					<div class="col-md-10">
						...
						<textarea class="form-control" name="alamat_pengiriman" placeholder="Contoh: Jln.xxxx . Lingk.kramat. kodepos:12345" required="harus diisi"></textarea>
						</div>
					</div>
