...
<?php
  if(isset($_POST['buttonhapus'])){
    ...
    $querydelete = "DELETE FROM antrian WHERE id_antrian=$id_antrian";
...
<!-- Modal hapus -->
  <div class="modal fade" id="modalhapus<?php echo $row['id_antrian'];?>" tabindex="-1"
...
<!--Perintah MENAMPILKAN hapus atau modal hapus -->
      ...
      $id=$row['id_antrian'];
      $queryselecthapus = "SELECT * FROM antrian WHERE id_antrian=$id";
...
<!-- modal hapus -->
        <form method="post">
            <div class="modal-body">
              <input type="hidden" name="id_antrian" value="<?php echo $id;?>">
              Apakah anda yakin ingin menghapus data antrian <strong><?php echo $rowselecthapus['plat_nomer'];?></strong> ini?
            </div>
