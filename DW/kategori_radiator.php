...
<span class="badge badge-primary" style="font-size: 20px;margin-bottom: 40px">Produk Jenis radiator</span>

					<div class="row">

				<?php $ambil = $koneksi ->query("SELECT * FROM produk where jenis_produk='radiator'"); ?><!-- dari database belajar -->
