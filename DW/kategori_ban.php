...
<span class="badge badge-primary" style="font-size: 20px;margin-bottom: 40px">Produk Jenis Ban</span>

					<div class="row">

				<?php $ambil = $koneksi ->query("SELECT * FROM produk where jenis_produk='ban'"); ?><!-- dari database belajar -->
